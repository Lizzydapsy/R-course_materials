...
A basic dataframe organizes data into a two-dimensional grid of rows and colums, much like a spreadsheet. In general, we will refer to the rows of the dataframe as observations, and the  columns as variables.
...
Produce the following data frame from Elephants_data using filter(); you need to identify the observations for where it is
TRUE that the Sex is female
...
Don’t forget to start your script with ## for annotation libraries, data import,
